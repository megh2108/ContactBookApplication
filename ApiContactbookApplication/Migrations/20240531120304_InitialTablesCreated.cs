    ...
    public partial class InitialTablesCreated : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Contactbooks", x => x.ContactId);
                    table.ForeignKey(
                        name: "FK_Contactbooks_Countries_CountryId",
                        column: x => x.CountryId,
                        principalTable: "Countries",
                        principalColumn: "CountryId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Contactbooks_States_StateId",
                        column: x => x.StateId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Contactbooks_CountryId",
                table: "Contactbooks",
                column: "CountryId");

            migrationBuilder.CreateIndex(
                name: "IX_Contactbooks_StateId",
                table: "Contactbooks",
                column: "StateId");
