...
{
    public partial class AlterReportsSp : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql(@"
                  CREATE OR ALTER PROCEDURE GetAllContactsCountByCountry
                    ...
                    AS
                    BEGIN
                        SELECT Count(c.ContactId) AS Count FROM Contactbooks c WHERE c.CountryId = @CountryId
            ...
            migrationBuilder.Sql(@"
                ...
                AS
                BEGIN
                 SELECT Count(c.ContactId) AS Count FROM Contactbooks c WHERE c.Gender = @Gender
