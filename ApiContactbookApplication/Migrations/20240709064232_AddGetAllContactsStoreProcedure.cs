...
{
    public partial class AddGetAllContactsStoreProcedure : Migration
    {
           ...
           CREATE OR ALTER PROCEDURE GetAllContactsByPagination
			...
			BEGIN
			 DECLARE @Skip INT = (@Page - 1) * @PageSize;
				 ...
				 IF @SortOrder = 'asc'
					BEGIN
						SELECT c.ContactId,c.Name, c.Email,  c.PhoneNumber ,c.Company ,c.FileName, c.BirthDate , c.Gender, c.Favourite , co.CountryName , s.StateName FROM Contactbooks c
